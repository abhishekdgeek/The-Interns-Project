...
<link rel="icon" sizes="144x144" type="image/png" href="images/fav.png">
<!-- Latest compiled and minified CSS -->
      ...
      <nav class="navbar navbar-inverse navbar-fixed-top">
        <div class="container-fluid">
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#"><img class="logo" src="images/solomo-logo.svg" alt="solomo logo"></a>
          </div>
...
<!-- controls grid system maintaining gap between columns-->
 ...
 <div class="row">
	 <div class="col-xs-12 col-md-6">
       <img src="images/back1.jpg" class="img-responsive" alt="SOCIAL"></div>
         <div class="col-xs-12 col-md-6">
		 <div class="row">
