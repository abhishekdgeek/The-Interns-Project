...
<?php 
/* call the classes of both originalslicer and blurredslicer and then storing values of images in database and retrieving it from database and then displaying blurred parts and original parts according to the shares*/
